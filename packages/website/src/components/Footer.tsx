    ...
    <footer className="bg-black pt-20 pb-10 border-t border-rnrGrey-80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-16">
          <div className="mb-8">
            <Logo name="swm" className="h-16 w-auto text-rnrGrey-0" />
          </div>
          <SectionHeader
        ...
        <div className="bg-[#111] border border-rnrGrey-80 p-8 rounded-sm flex flex-col md:flex-row items-center justify-between gap-6 mb-20 max-w-4xl mx-auto">
          <h3 className="text-xl font-medium text-rnrGrey-0 text-center md:text-left">
            Do you have a software project that we
            <br />
            can help you with?
          </h3>
          <a
        ...
        <div className="flex justify-center space-x-6 mb-16">
          ...
          />
          <SocialLink
            href="https://youtube.com/@SoftwareMansion"
        ...
        <div className="border-t border-rnrGrey-80 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-rnrGrey-50">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            ...
            <span className="bg-rnrGrey-0 text-black px-1 rounded-sm text-[10px] font-bold">
              BETA
            </span>
          </div>

          <div className="flex space-x-6 mb-4 md:mb-0">
            <a href="#" className="hover:text-rnrGrey-0 transition-colors">
              Setup
            </a>
            <a href="#" className="hover:text-rnrGrey-0 transition-colors">
              Benefits
            ...
            <a
              href="#"
              className="hover:text-rnrGrey-0 transition-colors flex items-center gap-1"
            >
...
const SocialLink: React.FC<{ href: string; icon: React.ReactNode }> = ({
  ...
  <a
    ...
    target="_blank"
    rel="noopener noreferrer"
    className="w-10 h-10 bg-rnrGrey-0/10 rounded-full flex items-center justify-center text-rnrGrey-0 hover:bg-rnrGrey-0/20 transition-colors"
  >
